...
st.subheader("El Sabor del Futuro: Cocina Inteligente a tu Alcance")
st.write('La cocina ya no es solo cuestión de intuición; ahora tienes un copiloto digital listo para ayudarte a crear platos extraordinarios.')
           
st.markdown(f"¿Listo para llevar tu cocina al siguiente nivel? Es el momento de romper el hielo y empezar a charlar con tu agente de IA")
